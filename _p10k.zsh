...
() {
  ...
  # Remove the icon (like home) from the directory segment
  ...
  # Disable time update on every command so it shows command start time.
  ...
  function prompt_my_prompt() {
    p10k segment -b '' -t '%F{yellow}%t%f %F{yellow}%n@%m%f %F{green}%~%f'
  }
  ...
  typeset -g POWERLEVEL9K_MY_PROMPT_LEFT_SEGMENT_SEPARATOR=''
  typeset -g POWERLEVEL9K_MY_PROMPT_RIGHT_SEGMENT_SEPARATOR=''
